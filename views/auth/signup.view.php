...
<main class="h-screen overflow-hidden flex items-center justify-center">
    <div class="bg-white lg:w-6/12 md:7/12 w-8/12 shadow-3xl rounded-xl">
        <div
            class="bg-green-400 shadow shadow-gray-200 absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-full p-4 md:p-8">
        ...
        <form class="p-12 md:p-24" action="signup" method="POST">
            ...
            <div class="flex items-center text-lg mb-6">
                ...
                <input type="text" name="nombre" id="nombre"
                    class="bg-gray-200 rounded pl-12 py-2 md:py-4 focus:outline-none w-full" placeholder="Nombre"
                    required />
            </div>
            ...
            <div class="flex items-center text-lg mb-6">
                ...
                <input type="text" name="apellidos" id="apellidos"
                    class="bg-gray-200 rounded pl-12 py-2 md:py-4 focus:outline-none w-full" placeholder="Apellidos"
                    required />
            </div>
            ...
            <button type="submit"
                class="bg-green-400 text-green-700 hover:bg-green-700 hover:text-white px-3 py-4 rounded-md text-sm font-medium uppercase w-full">Registrarse</button>
        </form>
    </div>
