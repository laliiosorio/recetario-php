...
<main class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    ...
    <form action="/recetario-php/recipes" method="GET" class="flex flex-col my-10 p-6 bg-white rounded-md">
        ...
        <button type="submit" class="text-green-700 bg-green-400 w-28 py-1 px-3 text-center rounded-md mt-5 self-end">Apply
            Filters</button>
    </form>
        ...
        <?php foreach ($recipes as $recipe) : ?>
            ...
            <a href="/recetario-php/recipe?id=<?php echo $recipe['id']; ?>" class="hover:shadow-lg">
                <div class="bg-white rounded-md overflow-hidden relative shadow-md">
                    <div>
                        <img class="w-full h-48 object-cover" src="<?php echo '../img/' . $recipe['image']; ?>" alt="<?php echo $recipe['name']; ?>">
                    </div>
                    <div class="p-4">
                        ...
                        <div class="flex justify-between mt-4 mb-4 text-gray-500">
                            ...
                            <div class="flex items-center">
                                <span class="ml-1 text-lg font-bold text-green-700"><?php echo ucfirst($recipe['category']); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="text-green-700 flex justify-self-end items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M2 0a2 2 0 00-2 2v16a2 2 0 002 2h16a2 2 0 002-2V2a2 2 0 00-2-2H2zm1 4a1 1 0 011-1h12a1 1 0 011 1v1H2V4zm0 4h16v10H2V8zm4-4a1 1 0 00-1 1v2a1 1 0 002 0V9a1 1 0 00-1-1zm6 0a1 1 0 00-1 1v2a1 1 0 002 0V9a1 1 0 00-1-1z" clip-rule="evenodd" />
                            </svg>
    ...
    <div class="w-64 mx-auto flex items-center">
        <div class="w-full flex items-center justify-between my-12">
            <a href="?page=<?php echo $page - 1; ?>" class="<?= $page > 1 ? 'text-green-700 bg-green-400' : 'pointer-events-none bg-gray-200 text-gray-400' ?> w-28 py-1 px-3 text-center rounded-md">&larr;
                Anterior</a>
            <a href="?page=<?php echo $page + 1; ?>" class="<?= $page < $totalPages ? 'text-green-700 bg-green-400' : 'pointer-events-none bg-gray-200 text-gray-400' ?> w-28 py-1 px-3 text-center rounded-md">Siguiente
                &rarr;</a>
        </div>
    </div>
</main>
