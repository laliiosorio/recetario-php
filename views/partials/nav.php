              ...
              <div class="flex items-center">
                  ...
                  <div class="hidden md:block">
                      <div class="ml-10 flex items-baseline space-x-4">
                          ...
                          <a href="<?= $baseURL ?>/about" class="<?= urlIs('/about', $baseURL) ? 'bg-green-700 text-green-400' : 'text-green-700' ?> hover:bg-green-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">About</a>
                          <a href="<?= $baseURL ?>/contact" class="<?= urlIs('/contact', $baseURL) ? 'bg-green-700 text-green-400' : 'text-green-700' ?> hover:bg-green-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Contact</a>
                      </div>
                  </div>
              </div>
          </div>
