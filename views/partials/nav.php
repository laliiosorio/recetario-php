              ...
              <div class="w-full flex items-center">
                  <div class="flex-shrink-0">
                      <div class="text-green-700">
                          <svg fill="currentColor" width="50px" height="50px" viewBox="0 0 14 14" role="img"
                  ...
                  <div class="w-full flex items-center justify-between">
                      <div class="block">
                          <div class="ml-10 flex items-baseline space-x-4">
                              <a href="<?= $baseURL ?>/"
                                  class="<?= urlIs('/', $baseURL) ? 'bg-green-700 text-green-400' : 'text-green-700' ?> hover:bg-green-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Home</a>
                              <a href="<?= $baseURL ?>/recipes"
                                  class="<?= urlIs('/recipes', $baseURL) ? 'bg-green-700 text-green-400' : 'text-green-700' ?> hover:bg-green-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Recetas</a>
                              <a href="<?= $baseURL ?>/activity-2"
                                  class="<?= urlIs('/activity-2', $baseURL) ? 'bg-green-700 text-green-400' : 'text-green-700' ?> hover:bg-green-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Act_2</a>
                              <a href="<?= $baseURL ?>/api/recipes"
                                  class="<?= urlIs('/api/recipes', $baseURL) ? 'bg-green-700 text-green-400' : 'text-green-700' ?> hover:bg-green-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">API_recetas</a>
                              <a href="<?= $baseURL ?>/api/recipe"
                                  class="<?= urlIs('/api/recipe', $baseURL) ? 'bg-green-700 text-green-400' : 'text-green-700' ?> hover:bg-green-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">API_receta</a>
                          </div>
                      </div>
                      ...
                      <div class="flex items-center">
                          ...
                          <a href="<?= $baseURL ?>/login"
                              class="<?= urlIs('/login', $baseURL) ? 'bg-green-700 text-green-400' : 'text-green-700' ?> hover:bg-green-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Inciar
                              sesión</a>
                          <a href="<?= $baseURL ?>signup"
                              class="<?= urlIs('signup', $baseURL) ? 'bg-green-700 text-green-400' : 'text-green-700' ?> hover:bg-green-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Registrarse</a>
                          <?php endif; ?>

                          <?php if (isset($_SESSION['username'])) : ?>
                          <p>Bienvenido/a, <?php echo htmlspecialchars($_SESSION['username']); ?></p>
                          <a href="<?= $baseURL ?>signup"
                              class="<?= urlIs('signup', $baseURL) ? 'bg-green-700 text-green-400' : 'text-green-700' ?> hover:bg-green-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Perfil</a>
                          <form action="logout" method="POST">
                              <button type="submit"
                                  class="bg-red-500 hover:bg-red-700 text-white px-3 py-2 rounded-md text-sm font-medium ml-4">Logout</button>
                          </form>
                          <?php endif; ?>
                      </div>
                  </div>
